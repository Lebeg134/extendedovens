...
@Mod(CreateOvensExtended.MODID)
public class CreateOvensExtended {
    ...
    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> EXAMPLE_TAB = CREATIVE_MODE_TABS.register("example_tab", () -> CreativeModeTab.builder()
            .title(Component.translatable("itemGroup.extendedovens")) //The language key for the title of your CreativeModeTab
    ...
    public CreateOvensExtended(IEventBus modEventBus, ModContainer modContainer) {
        ...
        // Note that this is necessary if and only if we want *this* class (CreateOvensExtended) to respond directly to events.
